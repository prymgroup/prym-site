export const FLEET = [
  ...
  },
  {
    ...
    models: [
      { name: 'Mercedes Classe V', modelPath: '/models/lounge_vclass.glb' },
    ],
    modelPath: '/models/lounge_vclass.glb',
  ...
  },
  {
    ...
    models: [
      { name: 'Mercedes Sprinter VIP', modelPath: '/models/suite_sprinter.glb' },
    ],
    modelPath: '/models/suite_sprinter.glb',
