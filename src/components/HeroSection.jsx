...
export default function HeroSection() {
  ...
  return (
    <section style={{
      ...
      position: 'relative', overflow: 'hidden', backgroundColor: '#0a0a0a',
    }}>
      <div aria-hidden style={{
        position: 'absolute', inset: 0,
        background: 'radial-gradient(ellipse 55% 45% at 50% 48%, rgba(198,198,198,0.04) 0%, rgba(198,198,198,0.01) 45%, transparent 70%)',
        pointerEvents: 'none',
      }} />
      ...
      <motion.div style={{
        ...
        <div style={{ position: 'relative', width: 'clamp(240px, 34vw, 520px)' }}>
          <img src="/logos/logo-slogan-white.svg" alt="PRYM Executive Transport" draggable={false}
          ...
          <motion.div
            ...
            style={{
              position: 'absolute', inset: 0,
              background: 'linear-gradient(170deg, #2c2c2b 0%, #706f6f 22%, #c6c6c6 42%, #d4d4d4 50%, #b0b0b0 60%, #706f6f 78%, #2c2c2b 100%)',
              WebkitMaskImage: 'url(/logos/logo-slogan-white.svg)', maskImage: 'url(/logos/logo-slogan-white.svg)',
        ...
        <motion.p
          ...
          style={{
            ...
            color: '#3c3c3b', marginTop: 'clamp(1.2rem, 3vh, 2rem)', textAlign: 'center',
          }}
        >
          {t.tagline}
        </motion.p>
      ...
      <motion.div
        initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 2.8, duration: 1.2 }}
        style={{
          position: 'absolute', bottom: '2.8rem', left: '50%', transform: 'translateX(-50%)',
          display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.75rem', opacity,
        }}
      >
        <span style={{
          fontFamily: FONT, fontSize: '0.48rem', letterSpacing: '0.5em',
          color: '#3c3c3b', textTransform: isAR ? 'none' : 'uppercase',
        }}>
          {t.scroll}
        </span>
        <motion.div
          style={{ width: 1, height: 48, backgroundColor: '#3c3c3b', transformOrigin: 'top', willChange: 'transform' }}
